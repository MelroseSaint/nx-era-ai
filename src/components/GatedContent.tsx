...
const GatedContent: React.FC<GatedContentProps> = ({ children, fallbackMessage = "Subscribe to unlock this content!" }) => {
    ...
    return (
      <Card className="w-full max-w-md mx-auto mt-8">
        ...
        <CardContent className="flex flex-col items-center space-y-4">
          <p className="text-gray-700 dark:text-gray-300">Please log in to view this content.</p>
  ...
  return (
    <Card className="w-full max-w-md mx-auto mt-8">
      ...
      <CardContent className="flex flex-col items-center space-y-4">
        <p className="text-lg font-medium text-gray-700 dark:text-gray-300">{fallbackMessage}</p>
